...
class[[eosio::contract("backtoken")]] backtoken : public contract{
   public:
	...
	ACTION ontransferlog(name from, name to, const vector<token_ex>& tokens, const string& memo) {
		require_auth(get_self());
	}
	using ontransferlog_action = action_wrapper<"ontransferlog"_n, &backtoken::ontransferlog>;
